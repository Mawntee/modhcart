...
## Who is it for?
This template is geared towards MAPPERS, not designers, 3D modelers, lighting techs, or comp-sci majors.
...
I am also currently working on a modular version as well for the people that know a bit more about what they're doing.
This will have all functions/defines/styling/setup/export/whatever handled by their own files, and the main "working" script is focused just around the stuff you wanna write without the added clutter.
